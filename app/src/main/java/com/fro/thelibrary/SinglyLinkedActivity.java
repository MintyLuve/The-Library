...
public class SinglyLinkedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Values.question1){
            correct(question1_text, 'C', question1, 25, question1_A, question1_B, question1_C, question1_D, 1);
        }
        else{
            question1_A.setOnClickListener(v -> question1.setText(question1_text + " | A is incorrect"));
            question1_B.setOnClickListener(v -> question1.setText(question1_text + " | B is incorrect"));
            question1_C.setOnClickListener(v -> correct(question1_text, 'C', question1, 25, question1_A, question1_B, question1_C, question1_D, 1));
            question1_D.setOnClickListener(v -> question1.setText(question1_text + " | D is incorrect"));
        }
        if (Values.question2){
            correct(question2_text, 'D', question2, 50, question2_A, question2_B, question2_C, question2_D, 2);
        }
        else{
            question2_A.setOnClickListener(v -> question2.setText(question2_text + " | A is incorrect"));
            ...
            question2_D.setOnClickListener(v -> correct(question2_text, 'D', question2, 50, question2_A, question2_B, question2_C, question2_D, 2));
        }
        if (Values.question3){
